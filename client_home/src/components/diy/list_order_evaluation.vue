<template>
	<div class="diy_home diy_list diy_order_evaluation" id="diy_order_evaluation_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/order_evaluation/details?order_evaluation_id=' + o['order_evaluation_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/order_evaluation/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/order_evaluation/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						订单用户
							...
							<th class="diy_title" v-if="$check_field('get','evaluation_level')">
						评价等级
					</th>
							<th class="diy_title" v-if="$check_field('get','evaluation_content')">
						评价内容
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','evaluation_level')">
						<span>
							{{ o["evaluation_level"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','evaluation_content')">
						<span>
							{{ o["evaluation_content"] }}
						</span>
					</td>
					</tr>
			</table>
