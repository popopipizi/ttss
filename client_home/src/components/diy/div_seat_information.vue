<template>
	<div class="diy_details_box diy_div_seat_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/opening_table_information/edit','add')" @click="to_form('/opening_table_information/edit')" > 开桌 </button>
										</div>
						<!-- 富文本 -->
