	...
	<el-main class="bg table_wrap">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					...
					<el-form-item label="须知">
									<el-input v-model="query.notice"></el-input>
								</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="cart_description" label="描述" min-width="200">
				...
				<el-table-column prop="notice" @sort-change="$sortChange" label="须知"
				v-if="user_group == '管理员' || $check_field('get','notice')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/dish_information/table','set') || $check_action('/dish_information/view','set') || $check_action('/dish_information/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
